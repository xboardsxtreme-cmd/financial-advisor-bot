    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0a0e1a 0%, #0d1b2a 100%)", fontFamily: "'DM Sans', sans-serif", color: "#e8dcc8" }}>
      ...
      <div style={{ background: "rgba(7,9,15,0.9)", backdropFilter: "blur(20px)", borderBottom: "1px solid rgba(200,160,80,0.15)", padding: "16px 24px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <button onClick={() => loadClients(sheetUrl || PUBLISHED_TSV_URL)} style={{ padding: "8px 16px", background: "rgba(76,175,130,0.15)", border: "1px solid rgba(76,175,130,0.3)", borderRadius: 8, color: "#4caf82", fontSize: 12, cursor: "pointer" }}>🔄 Refresh</button>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "24px 18px" }}>
        ...
        {clients.length === 0 && !loading && !error && (
          <div style={{ textAlign: "center", padding: "40px" }}>
            <button onClick={() => loadClients(sheetUrl || PUBLISHED_TSV_URL)} style={{ padding: "14px 36px", background: "linear-gradient(135deg, #c8a050, #e8c878)", border: "none", borderRadius: 10, color: "#0a1628", fontSize: 14, fontWeight: "bold", cursor: "pointer" }}>
              📊 Load Clients
            </button>
          </div>
        )}
